...
selectable-set-thief-smuggler-description =
    ...
    Включает: маячок Фултона, 10 фултонов, 3 дымовые гранаты,
...
selectable-set-syndicate-spy-description =
    ...
    Включает: перчатки вора-хамелеона, набор хамелеона,
    голосовую маску, агентская ID карта,
    гипопен с бутылочкой ноктюрина, камера жучок,
...
selectable-set-syndicate-hitman-description =
    ...
    специальный невидимый бронежилет, нескользящую обувь, пачка трав Interdyne,
...
selectable-set-syndicate-implants-description =
    ...
    Включает: питательный насос, ЭМИ, Побег, Свобода,
    Дым, Крав Мага, радио имплант синдиката,
    Сандевистан, парные клинки-богомолы и крутую куртку.
...
selectable-set-syndicate-hacker-description =
    ...
    её ИИ и боргов. ВЗЛОМИ ПЛАНЕТУ!
    Включает: Плата законов "Антимов", разрушитель аутентификации, EMAГ,
    заполненный ящик инструментов, радиоподавитель,
    эксперементальный телепортер синдиката, имплант бинарного декодера
    стильные очки и ключ шифрования синдиката.
...
selectable-set-syndicate-desword-description =
    ...
    Включает: двухклинковый энергетический меч, мини инъекторы гиперзина, всю одежду
...
selectable-set-syndicate-grenadier-description =
    ...
    РПС гренадёра, взрывозащитный рюкзак
    и столько гранат, что устанешь считать.
...
selectable-set-syndicate-friendship-description =
    ...
    Включает: дубинку контрактника, наручники, 4 импланта контроля разума,
    4 винтовки Мосина и 5 ключа шифрования синдиката для всех.

selectable-set-syndicate-carp-name = Набор карпа
selectable-set-syndicate-carp-description =
    Грр! Рррр! Грр... Грроу?! КОВАБУНГА!
    Включает:  Искусство Спящего карпа, 10 обезвоженных карпов и ключ шифрования синдиката.

selectable-set-syndicate-western-name = Western Bundle
selectable-set-syndicate-western-description =
    Зажгите вестерн голосигару, приподнимите шляпу и позвольте музыке играть.
    Содержит: вестерн голосигару, ключ шифрования синдиката, плечевая кобура,
    резонансный комбинезон, солнцезащитные очки, классическое пончо,
    ковбойскую шляпу и сапоги, два револьвера Питон, шесть спидлоадеров с бронебойными патронами .45 магнум,

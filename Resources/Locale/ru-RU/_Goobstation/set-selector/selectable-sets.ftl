...
selectable-set-syndicate-hacker-description =
    ...
    Включает: Плату законов "Антимов", разрушитель аутентификации, EMAГ,
    заполненный набор инструментов, глушилка связи,
    эксперементальный телепортер синдиката, имплант бинарного декодера
    стильные очки и синдикатские ключи шифрования.
...
selectable-set-syndicate-desword-description =
    ...
    Включает: двухклинковый энергетический меч, микровпрыскиватель гиперзина, всю одежду
